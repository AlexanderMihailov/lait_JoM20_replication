%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% mex_est_qifspq_099_044_mh02_rng0twister_kll.m   % _kll appended to name, AM160518 
% Last modified: AM160613 - SEE genTheta_mex099_044_kll.m in the "Functions calls" subsection below
...
% Final modification and check (plus uniform formating: max 110 columns): Alexander Mihailov, 13 June 2016
%
...
%AM150805: added next 
%     genTheta_mex099_044_kll.m - fixes the 2 calibrated parameters, beta
...
warning off
delete output.txt
diary('mex_est_qifspq_099_044_mh02_rng0twister_kll_output.txt') 
     %AM150809: country- and calibration-specific output file name 
disp('Estimating for Mexico_kll: NK-foreign VAR model & muq not zero')
...
save initiallikepriNK_mex_est_qifspq_099_044_mh02_rng0twister_kll loglikelogpri %AM160222
...
for j=1:N,
        ...
        [newTheta] = genTheta_mex099_044_kll(Theta, 0, variance_normal, npara, bounds);    %generate new Theta
...
fid4=fopen('mex_est_qifspq_099_044_mh02_rng0twister_kll_NKsummary.txt','w+');
...
matrix2latex2(priormat, 'mex_est_qifspq_099_044_kll_MEXprior.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');

collabel = {'Post Mean','Post SD','2.5%','97.5%'};        
matrix2latex2(newstatmat, 'mex_est_qifspq_099_044_mh02_rng0twister_kll_MEXstat.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny'); 
        
% AM160222: adding a table for convmat
collabel = {'NSE(8%)','p-value','B-G'};        
matrix2latex2(convmat, 'mex_est_qifspq_099_044_mh02_rng0twister_kll_MEXconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');
...
matrix2latex2(statconvmat, 'mex_est_qifspq_099_044_mh02_rng0twister_kll_MEXstatconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');
...
disp('DONE estimating for Mexico_kll: NK-foreign VAR model & muq not zero')