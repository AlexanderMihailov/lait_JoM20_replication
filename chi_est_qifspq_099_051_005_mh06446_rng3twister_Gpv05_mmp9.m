%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% chi_est_qifspq_099_051_005_mh06446_rng3twister_Gpv05_mmp9.m
% Last modified: AM190604/0611/0825 -> mmp9 version; AM160725 - SEE genTheta_chi099_051_005_mmp9.m in the "Functions calls"
...
% for the an IMF/IFS (and OECD/National Accounts) quarterly data.
%
...
%AM150805: added next 
%     genTheta_chi099_051_005_mmp9.m - fixes the 3 calibrated parameters, beta,
...
warning off
delete output.txt
diary('chi_est_qifspq_099_051_005_mh06446_rng3twister_Gpv05_mmp9_output.txt') 
...
mh_scale = 0.6446 % 0.68545;    % scale varince to obtain optimal acceptance rate (20%)
...
sampldate = 1999;
startdate = 2003; %AM150730: 2001 and 2002 are NOISY, with TRENDING DOWN inflation and interest rates in Chile
...
%Error in chi_est_qifspq_099_051_005_mh06446_rng3twister_Gpv05_mmp9 (line 364)
...
%
%Error in chi_est_qifspq_099_051_005_mh06446_rng3twister_Gpv05_mmp9 (line 263)
%    Theta = mh_init "
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
save initiallikepriNK_chi_est_qifspq_099_051_005_mh06446_rng3twister_Gpv05_mmp9 loglikelogpri %AM160222 %AM190604 _mmp9
...
for j=1:N,
        ...
        [newTheta] = genTheta_chi099_051_005_mmp9(Theta, 0, variance_normal, npara, bounds); %generate new Theta
                                  %AM190604 _mmp9  
...
fid4=fopen('chi_est_qifspq_099_051_005_mh06446_rng3twister_Gpv05_mmp9_NKsummary.txt','w+'); %AM190604 _mmp9
...
matrix2latex2(newstatmat, 'chi_est_qifspq_099_051_005_mh06446_rng3twister_Gpv05_mmp9_CHIstat.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny'); 
        
% AM160222: adding a table for convmat
collabel = {'NSE(8\%)','p-value','B-G'};        
matrix2latex2(convmat, 'chi_est_qifspq_099_051_005_mh06446_rng3twister_Gpv05_mmp9_CHIconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny');
...
matrix2latex2(statconvmat, 'chi_est_qifspq_099_051_005_mh06446_rng3twister_Gpv05_mmp9_CHIstatconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny');
