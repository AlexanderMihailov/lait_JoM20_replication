%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% mex_est_qifspq_099_044_mh02_rng0twister_kll_muq0.m   % _kll_muq0 appended to name, AM160518 
% Last modified: AM160707 - SEE genTheta_mex099_044_kll_muq0.m in the "Functions calls" subsection below
...
%AM150805: added next 
%     genTheta_mex099_044_kll_muq0.m - fixes the 2 calibrated parameters, beta
%          and alpha, respectively, for Mexico as indicated by the filename
%          NEEDS TO BE CHANGED FOR ANY ALTERNATIVE CALIBRATION!
...
warning off
delete output.txt
diary('mex_est_qifspq_099_044_mh02_rng0twister_kll_muq0_output.txt') 
     %AM150809: country- and calibration-specific output file name 
disp('Estimating for Mexico_kll_muq0: NK-foreign VAR model & muq NOW zero')
...
[newdata,dtitle,date_vec] = mex_datadoc_qifspq(COUNTRY,data,datadate,interval,sampldate,startdate,PLOT_DATA);
...
save initiallikepriNK_mex_est_qifspq_099_044_mh02_rng0twister_kll_muq0 loglikelogpri %AM160222
...
for j=1:N,
        ...
        [newTheta] = genTheta_mex099_044_kll_muq0(Theta, 0, variance_normal, npara, bounds);    %generate new Theta
...
fid4=fopen('mex_est_qifspq_099_044_mh02_rng0twister_kll_muq0_NKsummary.txt','w+');
...
matrix2latex2(priormat, 'mex_est_qifspq_099_044_kll_muq0_MEXprior.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');

collabel = {'Post Mean','Post SD','2.5%','97.5%'};        
matrix2latex2(newstatmat, 'mex_est_qifspq_099_044_mh02_rng0twister_kll_muq0_MEXstat.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny'); 
        
% AM160222: adding a table for convmat
collabel = {'NSE(8%)','p-value','B-G'};        
matrix2latex2(convmat, 'mex_est_qifspq_099_044_mh02_rng0twister_kll_muq0_MEXconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');
...
matrix2latex2(statconvmat, 'mex_est_qifspq_099_044_mh02_rng0twister_kll_muq0_MEXstatconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');
...
disp('DONE estimating for Mexico_kll_muq0: NK-foreign VAR model & muq not zero')