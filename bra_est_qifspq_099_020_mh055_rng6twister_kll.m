%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% bra_est_qifspq_099_020_mh055_rng6twister_kll.m   % _kll appended to name, AM160518 
% Last modified: AM160706 - SEE genTheta_bra099_020_kll.m in the "Functions calls" subsection below
...
% Final modification and check (plus uniform formating: max 110 columns): Alexander Mihailov, 6 July 2016
%
...
%AM150805: added next 
%     genTheta_bra099_020_kll.m - fixes the 2 calibrated parameters, beta
...
warning off
delete output.txt
diary('bra_est_qifspq_099_020_mh055_rng6twister_kll_output.txt') 
     %AM150809: country- and calibration-specific output file name 
disp('Estimating for Brazil_kll: NK-foreign VAR model & muq not zero')
...
save initiallikepriNK_bra_est_qifspq_099_020_mh055_rng6twister_kll loglikelogpri %AM160222
...
for j=1:N,
        ...
        [newTheta] = genTheta_bra099_020_kll(Theta, 0, variance_normal, npara, bounds);    %generate new Theta
...
fid4=fopen('bra_est_qifspq_099_020_mh055_rng6twister_kll_NKsummary.txt','w+');
...
matrix2latex2(priormat, 'bra_est_qifspq_099_020_kll_BRAprior.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');

collabel = {'Post Mean','Post SD','2.5%','97.5%'};        
matrix2latex2(newstatmat, 'bra_est_qifspq_099_020_mh055_rng6twister_kll_BRAstat.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny'); 
        
% AM160222: adding a table for convmat
collabel = {'NSE(8%)','p-value','B-G'};        
matrix2latex2(convmat, 'bra_est_qifspq_099_020_mh055_rng6twister_kll_BRAconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');
...
matrix2latex2(statconvmat, 'bra_est_qifspq_099_020_mh055_rng6twister_kll_BRAstatconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');
...
disp('DONE estimating for Brazil_kll: NK-foreign VAR model & muq not zero')