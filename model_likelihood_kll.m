function [ L, PROBLEM1,PROBLEM2,PROBLEM3 ] = model_likelihood_kll(Theta,dy,ny,nx,POLICY,nlp)

% model_likelihood_kll.m
%
...
%
% Function calls:     
% model_solve_kll.m solves RE model with optimal commitment or discretion policy 
...
[PP,QQ,PROBLEM1] = model_solve_kll(Theta,POLICY); % _kll appended to name, AM160518
