%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% per_est_qifspq_099_035_005_mh0375_rng14twister_Gpv05_mmp9.m
% Last modified: AM190604/0611/0728 -> mmp9 version; AM160725 - SEE genTheta_per099_035_005_mmp9.m in the "Functions calls"
...
%AM150805: added next 
%     genTheta_per099_035_005_mmp9.m - fixes the 3 calibrated parameters, beta,
...
warning off
delete output.txt
diary('per_est_qifspq_099_035_005_mh0425_rng0twister_Gpv05_mmp9_output.txt') 
...
mh_scale = 0.375;    % scale variance to obtain optimal acceptance rate (20%)
...
%Error in per_est_qifspq_099_035_005_mh0375_rng0twister_Gpv05_mmp9 (line 364)
...
%
%Error in per_est_qifspq_099_035_005_mh0375_rng0twister_Gpv05_mmp9 (line 263)
%    Theta = mh_init "
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
save initiallikepriNK_per_est_qifspq_099_035_005_mh0375_rng0twister_Gpv05_mmp9 loglikelogpri %AM160222 %AM190604 _mmp9
...
for j=1:N,
        ...
        [newTheta] = genTheta_per099_035_005_mmp9(Theta, 0, variance_normal, npara, bounds); %generate new Theta
                                  %AM190604 _mmp9  
...
fid4=fopen('per_est_qifspq_099_035_005_mh0375_rng0twister_Gpv05_mmp9_NKsummary.txt','w+'); %AM190604 _mmp9
...
matrix2latex2(newstatmat, 'per_est_qifspq_099_035_005_mh0375_rng0twister_Gpv05_mmp9_PERstat.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny'); 
        
% AM160222: adding a table for convmat
collabel = {'NSE(8\%)','p-value','B-G'};        
matrix2latex2(convmat, 'per_est_qifspq_099_035_005_mh0375_rng0twister_Gpv05_mmp9_PERconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny');
...
matrix2latex2(statconvmat, 'per_est_qifspq_099_035_005_mh0375_rng0twister_Gpv05_mmp9_PERstatconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny');
