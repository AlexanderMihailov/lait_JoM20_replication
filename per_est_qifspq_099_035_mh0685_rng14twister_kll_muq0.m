%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% per_est_qifspq_099_035_mh0685_rng14twister_kll_muq0.m   % _kll_muq0 appended to name, AM160518 
% Last modified: AM160817 - SEE genTheta_per099_035_kll_muq0.m in the "Functions calls" subsection below
...
% Final modification and check (plus uniform formatting: max ~110 columns): Alexander Mihailov, 17 August 2016
%
...
%AM150805: added next 
%     genTheta_per099_035_kll_muq0.m - fixes the 2 calibrated parameters, beta
...
warning off
delete output.txt
diary('per_est_qifspq_099_035_mh0685_rng14twister_kll_muq0_output.txt') 
     %AM150809: country- and calibration-specific output file name 
disp('Estimating for Peru_kll_muq0: NK-foreign VAR model & muq NOW zero')
...
mh_scale = 0.685;   % scale variance to obtain optimal acceptance rate (20%)
...
save initiallikepriNK_per_est_qifspq_099_035_mh0685_rng14twister_kll_muq0 loglikelogpri %AM160222
...
for j=1:N,
        ...
        [newTheta] = genTheta_per099_035_kll_muq0(Theta, 0, variance_normal, npara, bounds);    %generate new Theta
...
fid4=fopen('per_est_qifspq_099_035_mh0685_rng14twister_kll_muq0_NKsummary.txt','w+');
...
matrix2latex2(priormat, 'per_est_qifspq_099_035_kll_muq0_PERprior.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');

collabel = {'Post Mean','Post SD','2.5%','97.5%'};        
matrix2latex2(newstatmat, 'per_est_qifspq_099_035_mh0685_rng14twister_kll_muq0_PERstat.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny'); 
        
% AM160222: adding a table for convmat
collabel = {'NSE(8%)','p-value','B-G'};        
matrix2latex2(convmat, 'per_est_qifspq_099_035_mh0685_rng14twister_kll_muq0_PERconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');
...
matrix2latex2(statconvmat, 'per_est_qifspq_099_035_mh0685_rng14twister_kll_muq0_PERstatconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');
...
disp('DONE estimating for Peru_kll_muq0: NK-foreign VAR model & muq not zero')