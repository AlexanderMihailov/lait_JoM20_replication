function [newdata,dtitle,date_vec] = chi_datadoc_qifspq(COUNTRY,data,datadate,interval,sampldate,startdate,PLOT_DATA)

% chi_datadoc_qifspq.m
% Last modified: AM150808; AM151219 (just the comment on line 133) 
%
...
% Functions called:
%   multiplot2Draw
%   chi_multiplot2Ddoc - AM150807: country-specific time-series sample, starting for Chile in 2004:01
%   suptitle2
%   hpfilter
...
i = 1;
while i < rows(datadate)-16 % AM150819 -16 = 4 years by 4 quarters, so as to start with index i=1=2003:1) is the correct date labelling here
    date_vec = [date_vec; date*ones(rows(interval),1) + interval];
    date = date+1;
 i = i + frequency;
  end
...
if PLOT_DATA
    chi_multiplot2Ddoc(newdata,dtitle,date_vec);
