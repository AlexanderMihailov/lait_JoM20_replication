%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% chi_est_qifspq_099_051_mh02_rng3twister_kll_muq0.m   % _kll_muq0 appended to name, AM160518 
% Last modified: AM160704 - SEE genTheta_chi099_051_kll_muq0.m in the "Functions calls" subsection below
...
% Final modification and check (plus uniform formatting: max ~110 columns): Alexander Mihailov, 4 July 2016
%
...
%AM150805: added next 
%     genTheta_chi099_051_kll_muq0.m - fixes the 2 calibrated parameters, beta
%          and alpha, respectively, for Chile as indicated by the filename
%          NEEDS TO BE CHANGED FOR ANY ALTERNATIVE CALIBRATION!
...
warning off
delete output.txt
diary('chi_est_qifspq_099_051_mh02_rng3twister_kll_muq0_output.txt') 
     %AM150809: country- and calibration-specific output file name 
disp('Estimating for Chile_kll_muq0: NK-foreign VAR model & muq NOW zero')
...
[newdata,dtitle,date_vec] = chi_datadoc_qifspq(COUNTRY,data,datadate,interval,sampldate,startdate,PLOT_DATA);
...
save initiallikepriNK_chi_est_qifspq_099_051_mh02_rng3twister_kll_muq0 loglikelogpri %AM160222
...
for j=1:N,
        ...
        [newTheta] = genTheta_chi099_051_kll_muq0(Theta, 0, variance_normal, npara, bounds);    %generate new Theta
...
fid4=fopen('chi_est_qifspq_099_051_mh02_rng3twister_kll_muq0_NKsummary.txt','w+');
...
matrix2latex2(priormat, 'chi_est_qifspq_099_051_kll_muq0_CHIprior.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');

collabel = {'Post Mean','Post SD','2.5%','97.5%'};        
matrix2latex2(newstatmat, 'chi_est_qifspq_099_051_mh02_rng3twister_kll_muq0_CHIstat.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny'); 
        
% AM160222: adding a table for convmat
collabel = {'NSE(8%)','p-value','B-G'};        
matrix2latex2(convmat, 'chi_est_qifspq_099_051_mh02_rng3twister_kll_muq0_CHIconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');
...
matrix2latex2(statconvmat, 'chi_est_qifspq_099_051_mh02_rng3twister_kll_muq0_CHIstatconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');
...
disp('DONE estimating for Chile_kll_muq0: NK-foreign VAR model & muq not zero')