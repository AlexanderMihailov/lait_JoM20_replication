%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% chi_est_qifspq_099_051_mh02_rng3twister_kll_mhinit0.m   % _kll appended to name, AM160518 
% Last modified: AM160530 - SEE genTheta_chi099_051_kll.m in the "Functions calls" subsection below
...
% Final modification and check (plus uniform formating: max 110 columns): Alexander Mihailov, 30 May 2016
%
...
%AM150805: added next 
%     genTheta_chi099_051_kll.m - fixes the 2 calibrated parameters, beta
...
warning off
delete output.txt
diary('chi_est_qifspq_099_051_mh02_rng3twister_kll_output.txt') 
     %AM150809: country- and calibration-specific output file name 
disp('Estimating for Chile_kll: NK-foreign VAR model & muq not zero')
...
%primeanTheta = pri(:,2); %AM160529 commented out: works much better with the initialisation used by KLL in their mh_init0
...
save initiallikepriNK_chi_est_qifspq_099_051_mh02_rng3twister_kll loglikelogpri %AM160222
...
for j=1:N,
        ...
        [newTheta] = genTheta_chi099_051_kll(Theta, 0, variance_normal, npara, bounds);    %generate new Theta
...
fid4=fopen('chi_est_qifspq_099_051_mh02_rng3twister_kll_NKsummary.txt','w+');
...
matrix2latex2(priormat, 'chi_est_qifspq_099_051_kll_CHIprior.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');

collabel = {'Post Mean','Post SD','2.5%','97.5%'};        
matrix2latex2(newstatmat, 'chi_est_qifspq_099_051_mh02_rng3twister_kll_CHIstat.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny'); 
        
% AM160222: adding a table for convmat
collabel = {'NSE(8%)','p-value','B-G'};        
matrix2latex2(convmat, 'chi_est_qifspq_099_051_mh02_rng3twister_kll_CHIconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');
...
matrix2latex2(statconvmat, 'chi_est_qifspq_099_051_mh02_rng3twister_kll_CHIstatconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');
...
disp('DONE estimating for Chile_kll: NK-foreign VAR model & muq not zero')