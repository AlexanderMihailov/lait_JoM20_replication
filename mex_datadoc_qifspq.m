function [newdata,dtitle,date_vec] = mex_datadoc_qifspq(COUNTRY,data,datadate,interval,sampldate,startdate,PLOT_DATA)

% mex_datadoc_qifspq.m
% Last modified: AM150808; AM151219 (just the comment on line 131)
%
% This script manipulates data imported into mex_estimate_qifspq.m. It also plots
...
% Functions called:
%   multiplot2Draw
%   mex_multiplot2Ddoc - AM150807: country-specific time-seried sample, starting for Mexico in 2002:1
%   suptitle2
%   hpfilter
...
tq_doc = [2002.00 2002.25 2002.50 2002.75 2003.00 2003.25 2003.50 2003.75 2004.00 2004.25 2004.50 2004.75 2005.00 2005.25 2005.50 2005.75 2006.00 2006.25 2006.50 2006.75 2007.00 2007.25 2007.50 2007.75 2008.00 2008.25 2008.50 2008.75 2009.00 2009.25 2009.50 2009.75 2010.00 2010.25 2010.50 2010.75 2011.00 2011.25 2011.50 2011.75 2012.00 2012.25 2012.50 2012.75 2013.00 2013.25 2013.50 2013.75 2014.00 2014.25 2014.50 2014.75]';

% 2000.00 2000.25 2000.50 2000.75 2001.00 2001.25 2001.50 2001.75 
...
date_vec = tq_doc(:); % AM150806 tq_doc indexes the correct date labelling here

i = 1;
while i < rows(datadate)-12 % AM150806; AM151219: -12 = 3 years by 4 quarters, so as to start with index i=1=2002:1 is the correct date labelling here
    date_vec = [date_vec; date*ones(rows(interval),1) + interval];
    date = date+1;
i = i + frequency;
end
...
if PLOT_DATA
    mex_multiplot2Ddoc(newdata,dtitle,date_vec);
