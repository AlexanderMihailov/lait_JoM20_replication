function [newdata,dtitle,date_vec] = per_datadoc_qifspq(COUNTRY,data,datadate,interval,sampldate,startdate,PLOT_DATA)

% per_datadoc_qifspq.m
% Last modified:AM1512123
%
% This script manipulates data imported into chi_estimate_qifspq.m. It also plots
...
% Functions called:
%   multiplot2Draw
%   chi_multiplot2Ddoc - AM150807: country-specific time-series sample, starting for Colombia in 2004:01
%   suptitle2
%   hpfilter
...
% 1999.00 1999.25 1999.50 1999.75 2000.00 2000.25 2000.50 2000.75 2001.00 2001.25 2001.50 2001.75 2002.00 2002.25 2002.50 2002.75 

tq_doc = [2005.00 2005.25 2005.50 2005.75 2006.00 2006.25 2006.50 2006.75 2007.00 2007.25 2007.50 2007.75 2008.00 2008.25 2008.50 2008.75 2009.00 2009.25 2009.50 2009.75 2010.00 2010.25 2010.50 2010.75 2011.00 2011.25 2011.50 2011.75 2012.00 2012.25 2012.50 2012.75 2013.00 2013.25 2013.50 2013.75 2014.00 2014.25 2014.50 2014.75]';

% 1999.00 1999.25 1999.50 1999.75 2000.00 2000.25 2000.50 2000.75 2001.00 2001.25 2001.50 2001.75 2002.00 2002.25 2002.50 2002.75 2003.00 2003.25 2003.50 2003.75 2004.00 2004.25 2004.50 2004.75       
...
date_vec = tq_doc(:); % AM150806 tq_doc indexes the correct date labelling here %AM150809

i = 1;
while i < rows(datadate)-24 % AM150810; AM151219: -24 = 6 years by 4 quarters, so as to start with index i=1=2005:1 is the correct date labelling here
    date_vec = [date_vec; date*ones(rows(interval),1) + interval];
    date = date+1;
 i = i + frequency;
  end

% AM150810 - commented out: date_vec = date_vec(1:end)
dtitle = datadate(1,2:end);

%AM150731: plot HP-smoothed and demeaned gap data and demeaned percentage (per annum) data
if PLOT_DATA
    per_multiplot2Ddoc(newdata,dtitle,date_vec);
