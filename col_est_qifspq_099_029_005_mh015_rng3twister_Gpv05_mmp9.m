%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% col_est_qifspq_099_029_005_mh015_rng3twister_Gpv05_mmp9.m
% Last modified: AM190604/0611/0720 -> mmp9 version; AM160725 - SEE genTheta_col099_029_005_mmp9.m in the "Functions calls"
...
%AM150805: added next 
%     genTheta_col099_029_005_mmp9.m - fixes the 3 calibrated parameters, beta,
%          alpha and chi, respectively, for Columbia as indicated by the filename
%          NEEDS TO BE CHANGED FOR ANY ALTERNATIVE CALIBRATION!
...
warning off
delete output.txt
diary('col_est_qifspq_099_029_005_mh015_rng3twister_Gpv05_mmp9_output.txt') 
     %AM150809: country- and calibration-specific output file name 
disp('Estimating for Columbia: NK-foreign VAR model & muq not zero')
...
mh_scale = 0.15;    % scale variance to obtain optimal acceptance rate (20%)
...
sampldate = 1999;
startdate = 2003; % AM150808: no earlier data for some series
...
%Error in col_est_qifspq_099_029_005_mh015_rng3twister_Gpv05_mmp9 (line 364)
...
%
%Error in col_est_qifspq_099_029_005_mh015_rng3twister_Gpv05_mmp9 (line 263)
%    Theta = mh_init "
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
save initiallikepriNK_col_est_qifspq_099_029_005_mh015_rng3twister_Gpv05_mmp9 loglikelogpri %AM160222 %AM190604 _mmp9
...
for j=1:N,
        ...
        [newTheta] = genTheta_col099_029_005_mmp9(Theta, 0, variance_normal, npara, bounds); %generate new Theta
                                  %AM190604 _mmp9  
...
fid4=fopen('col_est_qifspq_099_029_005_mh015_rng3twister_Gpv05_mmp9_NKsummary.txt','w+'); %AM190604 _mmp9
...
matrix2latex2(newstatmat, 'COL_est_qifspq_099_029_005_mh015_rng3twister_Gpv05_mmp9_colstat.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny'); 
        
% AM160222: adding a table for convmat
collabel = {'NSE(8\%)','p-value','B-G'};        
matrix2latex2(convmat, 'COL_est_qifspq_099_029_005_mh015_rng3twister_Gpv05_mmp9_colconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny');
...
matrix2latex2(statconvmat, 'COL_est_qifspq_099_029_005_mh015_rng3twister_Gpv05_mmp9_colstatconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny');
