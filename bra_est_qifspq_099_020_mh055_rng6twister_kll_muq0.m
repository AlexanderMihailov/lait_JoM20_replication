%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% bra_est_qifspq_099_020_mh055_rng6twister_kll_muq0.m   % _kll_muq0 appended to name, AM160518 
% Last modified: AM160707 - SEE genTheta_bra099_020_kll_muq0.m in the "Functions calls" subsection below
...
%AM150805: added next 
%     genTheta_bra099_020_kll_muq0.m - fixes the 2 calibrated parameters, beta
%          and alpha, respectively, for Brazil as indicated by the filename
%          NEEDS TO BE CHANGED FOR ANY ALTERNATIVE CALIBRATION!
...
warning off
delete output.txt
diary('bra_est_qifspq_099_020_mh055_rng6twister_kll_muq0_output.txt') 
     %AM150809: country- and calibration-specific output file name 
disp('Estimating for Brazil_kll_muq0: NK-foreign VAR model & muq NOW zero')
...
mh_scale = 0.55;    % scale variance to obtain optimal acceptance rate (20%)
...
sampldate = 1999;
startdate = 2004; % AM150808: 2002 and 2003 are NOISY, with a spike of inflation and interest rate and trending
                  % down interest rate (in the whole sample!) in Brazil

% Call function to manipulate and plot data
[newdata,dtitle,date_vec] = bra_datadoc_qifspq(COUNTRY,data,datadate,interval,sampldate,startdate,PLOT_DATA);
...
save initiallikepriNK_bra_est_qifspq_099_020_mh055_rng6twister_kll_muq0 loglikelogpri %AM160222
...
for j=1:N,
        ...
        [newTheta] = genTheta_bra099_020_kll_muq0(Theta, 0, variance_normal, npara, bounds);    %generate new Theta
...
fid4=fopen('bra_est_qifspq_099_020_mh055_rng6twister_kll_muq0_NKsummary.txt','w+');
...
matrix2latex2(priormat, 'bra_est_qifspq_099_020_kll_muq0_BRAprior.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');

collabel = {'Post Mean','Post SD','2.5%','97.5%'};        
matrix2latex2(newstatmat, 'bra_est_qifspq_099_020_mh055_rng6twister_kll_muq0_BRAstat.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny'); 
        
% AM160222: adding a table for convmat
collabel = {'NSE(8%)','p-value','B-G'};        
matrix2latex2(convmat, 'bra_est_qifspq_099_020_mh055_rng6twister_kll_muq0_BRAconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');
...
matrix2latex2(statconvmat, 'bra_est_qifspq_099_020_mh055_rng6twister_kll_muq0_BRAstatconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');
...
disp('DONE estimating for Brazil_kll_muq0: NK-foreign VAR model & muq not zero')