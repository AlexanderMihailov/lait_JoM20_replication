%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% bra_est_qifspq_099_020_005_mh0075_rng6twister_Gpv05_mmp9.m
% Last modified: AM190604/0611/0716 -> mmp9 version; AM160725 - SEE genTheta_bra099_020_005_mmp9.m in the "Functions calls"
...
% for the Brsilian IMF/IFS (and OECD/National Accounts) quarterly data.
%
...
%AM150805: added next 
%     genTheta_bra099_020_005_mmp9.m - fixes the 3 calibrated parameters, beta,
...
warning off
delete output.txt
diary('bra_est_qifspq_099_020_005_mh0075_rng0twister_Gpv05_mmp9_output.txt') 
...
mh_scale = 0.075;    % scale variance to obtain optimal acceptance rate (20%)
%AM190716: 0.55 as in the WP, 0.25, 0.15, 0.2, 0.1, 0.13, 0.18 also attempted
% with this prng 6 - but worse acceptance rate at the first completed percentage
...
%AM190716: the smaller 6 integers also attempted but worse acceptance rate at completed small percentages 
...
pri=[   0       0.99  0.001;  % AM160528 -> added Theta vector numbering: Theta(1); beta ~ calibrated
        0       0.2036471173   0.1;   % Theta(2); alpha ~ calibrated to the country-specific mean
...
%Error in bra_est_qifspq_099_020_005_mh0075_rng0twister_Gpv05_mmp9 (line 364)
...
%
%Error in bra_est_qifspq_099_020_005_mh0075_rng0twister_Gpv05_mmp9 (line 263)
%    Theta = mh_init "
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
save initiallikepriNK_bra_est_qifspq_099_020_005_mh0075_rng0twister_Gpv05_mmp9 loglikelogpri %AM160222 %AM190604 _mmp9
...
for j=1:N,
        ...
        [newTheta] = genTheta_bra099_020_005_mmp9(Theta, 0, variance_normal, npara, bounds); %generate new Theta
                                  %AM190604 _mmp9  
...
fid4=fopen('bra_est_qifspq_099_020_005_mh0075_rng0twister_Gpv05_mmp9_NKsummary.txt','w+'); %AM190604 _mmp9
...
%Thetapost02Trhog = Thetapost(:,27);     %AM160528: Picking up the
...
%Thetapost02Tsigmag = Thetapost(:,28);   %AM160528: Picking up the
...
%paran02Trhog = paran(27,:);   %AM160528: Picking up the LABELS for the persistence parameters (numbering as estimated)
%AM190604 _mmp9
paran02Tsigma = paran(18:26,:);%AM160528: Picking up the LABELS for the st.dev. parameters (numbering as estimated)
%paran02Tsigmag = paran(28,:);%AM160528: Picking up the LABELS for the st.dev. parameters (numbering as estimated)
%AM190604 _mmp9
...
matrix2latex2(newstatmat, 'bra_est_qifspq_099_020_005_mh0075_rng0twister_Gpv05_mmp9_BRAstat.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny'); 
        
% AM160222: adding a table for convmat
collabel = {'NSE(8\%)','p-value','B-G'};        
matrix2latex2(convmat, 'bra_est_qifspq_099_020_005_mh0075_rng0twister_Gpv05_mmp9_BRAconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny');
...
matrix2latex2(statconvmat, 'bra_est_qifspq_099_020_005_mh0075_rng0twister_Gpv05_mmp9_BRAstatconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny');
