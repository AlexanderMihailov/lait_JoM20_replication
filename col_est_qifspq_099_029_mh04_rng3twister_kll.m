%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% col_est_qifspq_099_029_mh04_rng3twister_kll.m   % _kll appended to name, AM160518 
% Last modified: AM160614 - SEE genTheta_col099_029_kll.m in the "Functions calls" subsection below
...
% Final modification and check (plus uniform formatting: max ~110 columns): Alexander Mihailov, 14 June 2016
%
...
%AM150805: added next 
%     genTheta_col099_029_kll.m - fixes the 2 calibrated parameters, beta
...
warning off
delete output.txt
diary('col_est_qifspq_099_029_mh04_rng3twister_kll_output.txt') 
     %AM150809: country- and calibration-specific output file name 
disp('Estimating for Colombia_kll: NK-foreign VAR model & muq not zero')
...
save initiallikepriNK_col_est_qifspq_099_029_mh04_rng3twister_kll loglikelogpri %AM160222
...
for j=1:N,
        ...
        [newTheta] = genTheta_col099_029_kll(Theta, 0, variance_normal, npara, bounds);    %generate new Theta
...
fid4=fopen('col_est_qifspq_099_029_mh04_rng3twister_kll_NKsummary.txt','w+');
...
matrix2latex2(priormat, 'col_est_qifspq_099_029_kll_COLprior.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');

collabel = {'Post Mean','Post SD','2.5%','97.5%'};        
matrix2latex2(newstatmat, 'col_est_qifspq_099_029_mh04_rng3twister_kll_COLstat.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny'); 
        
% AM160222: adding a table for convmat
collabel = {'NSE(8%)','p-value','B-G'};        
matrix2latex2(convmat, 'col_est_qifspq_099_029_mh04_rng3twister_kll_COLconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');
...
matrix2latex2(statconvmat, 'col_est_qifspq_099_029_mh04_rng3twister_kll_COLstatconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.2f','size', 'tiny');
...
disp('DONE estimating for Colombia_kll: NK-foreign VAR model & muq not zero')