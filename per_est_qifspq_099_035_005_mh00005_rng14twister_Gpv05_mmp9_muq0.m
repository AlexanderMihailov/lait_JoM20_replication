%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% per_est_qifspq_099_035_005_mh00005_rng14twister_Gpv05_mmp9_muq0.m
% Last modified: AM190604/0611/0901/1107 (muq=0) -> mmp9 version; AM160725 - SEE genTheta_per099_035_005_mmp9_muq0.m in the "Functions calls"
...
%AM150805: added next 
%     genTheta_per099_035_005_mmp9_muq0.m - fixes the 3 calibrated parameters, beta,
%          alpha and chi, respectively, for Peru as indicated by the filename
%          NEEDS TO BE CHANGED FOR ANY ALTERNATIVE CALIBRATION!
...
warning off
delete output.txt
diary('per_est_qifspq_099_035_005_mh00005_rng14twister_Gpv05_mmp9_muq0_output.txt') 
     %AM150809: country- and calibration-specific output file name 
disp('Estimating for Peru: NK-foreign VAR model & muq zero')
...
mh_scale = 0.0005;    % scale variance to obtain optimal acceptance rate (20%) [AM190814: after many trials from 0.05 to 1.5...]
...
sampldate = 1999;
startdate = 2005; % AM190812 Peru

% Call function to manipulate and plot data
[newdata,dtitle,date_vec] = per_datadoc_qifspq(COUNTRY,data,datadate,interval,sampldate,startdate,PLOT_DATA); % APR07042019: had trouble plotting data
...
%Error in per_est_qifspq_099_035_005_mh00005_rng14twister_Gpv05_mmp9 (line 364)
...
%
%Error in per_est_qifspq_099_035_005_mh00005_rng14twister_Gpv05_mmp9 (line 263)
%    Theta = mh_init "
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
save initiallikepriNK_per_est_qifspq_099_035_005_mh00005_rng14twister_Gpv05_mmp9_muq0 loglikelogpri %AM160222 %AM190604 _mmp9
...
for j=1:N,
        ...
        [newTheta] = genTheta_per099_035_005_mmp9_muq0(Theta, 0, variance_normal, npara, bounds); %generate new Theta
                                  %AM190604 _mmp9  
...
fid4=fopen('per_est_qifspq_099_035_005_mh00005_rng14twister_Gpv05_mmp9_muq0_NKsummary.txt','w+'); %AM190604 _mmp9
...
matrix2latex2(priormat, 'per_est_qifspq_099_035_005_PERprior.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny'); %AM160305 format 3 deicmals    

collabel = {'Post Mean','Post SD','2.5\%','97.5\%'};        
matrix2latex2(newstatmat, 'per_est_qifspq_099_035_005_mh00005_rng14twister_Gpv05_mmp9_muq0_PERstat.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny'); 
        
% AM160222: adding a table for convmat
collabel = {'NSE(8\%)','p-value','B-G'};        
matrix2latex2(convmat, 'per_est_qifspq_099_035_005_mh00005_rng14twister_Gpv05_mmp9_muq0_PERconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny');
...
matrix2latex2(statconvmat, 'per_est_qifspq_099_035_005_mh00005_rng14twister_Gpv05_mmp9_muq0_PERstatconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny');
...
disp('DONE estimating for Peru: NK-foreign VAR model & muq zero')