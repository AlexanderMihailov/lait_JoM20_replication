%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% chi_est_qifspq_099_051_005_mh005_rng0twister_Gpv05_mmp9_muq0.m
% Last modified: AM190604/0611/0820 (muq=0) -> mmp9 version; AM160725 - SEE genTheta_chi099_051_005_mmp9_muq0.m in the "Functions calls"
...
% for the Chilean IMF/IFS (and OECD/National Accounts) quarterly data.
%
...
%     
% Function calls:
%     chi_datadoc_qifspq.m to manipulate and plot data series
%AM150805: added next 
%     genTheta_chi099_051_005_mmp9_muq0.m - fixes the 3 calibrated parameters, beta,
%          alpha and chi, respectively, for Chile as indicated by the filename
%          NEEDS TO BE CHANGED FOR ANY ALTERNATIVE CALIBRATION!
...
warning off
delete output.txt
diary('chi_est_qifspq_099_051_005_mh005_rng0twister_Gpv05_mmp9_output.txt') 
     %AM150809: country- and calibration-specific output file name 
disp('Estimating for Chile: NK-foreign VAR model & muq not zero')
...
[data,datadate,raw] = xlsread('data/chidata_qifspq.xlsx'); % AM150730: NEW IFS-based data set including a proxy for d(t)
...
sampldate = 1999;
startdate = 2003; % AM190820 Chile

% Call function to manipulate and plot data
[newdata,dtitle,date_vec] = chi_datadoc_qifspq(COUNTRY,data,datadate,interval,sampldate,startdate,PLOT_DATA); % APR07042019: had trouble plotting data
...
% chi_datadoc_qifspq, THE REDUCTION BY 3 COLUMNS JUST ABOVE of newdata AFFECTS its SIZE, AND HENCE
...
pri=[   0       0.99  0.001;  % AM160528 -> added Theta vector numbering: Theta(1); beta ~ calibrated
        0       0.51473524   0.1;   % Theta(2); alpha ~ calibrated to the country-specific mean
...
%Error in chi_est_qifspq_099_051_005_mh005_rng0twister_Gpv05_mmp9 (line 364)
...
%
%Error in chi_est_qifspq_099_051_005_mh005_rng0twister_Gpv05_mmp9 (line 263)
%    Theta = mh_init "
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
save initiallikepriNK_chi_est_qifspq_099_051_005_mh005_rng0twister_Gpv05_mmp9 loglikelogpri %AM160222 %AM190604 _mmp9
...
for j=1:N,
        ...
        [newTheta] = genTheta_chi099_051_005_mmp9_muq0(Theta, 0, variance_normal, npara, bounds); %generate new Theta
                                  %AM190604 _mmp9  
...
fid4=fopen('chi_est_qifspq_099_051_005_mh005_rng0twister_Gpv05_mmp9_NKsummary.txt','w+'); %AM190604 _mmp9
...
matrix2latex2(priormat, 'chi_est_qifspq_099_051_005_CHIprior.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny'); %AM160305 format 3 deicmals    

collabel = {'Post Mean','Post SD','2.5\%','97.5\%'};        
matrix2latex2(newstatmat, 'chi_est_qifspq_099_051_005_mh005_rng0twister_Gpv05_mmp9_CHIstat.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny'); 
        
% AM160222: adding a table for convmat
collabel = {'NSE(8\%)','p-value','B-G'};        
matrix2latex2(convmat, 'chi_est_qifspq_099_051_005_mh005_rng0twister_Gpv05_mmp9_CHIconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny');
...
matrix2latex2(statconvmat, 'chi_est_qifspq_099_051_005_mh005_rng0twister_Gpv05_mmp9_CHIstatconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny');
...
disp('DONE estimating for Chile: NK-foreign VAR model & muq not zero')