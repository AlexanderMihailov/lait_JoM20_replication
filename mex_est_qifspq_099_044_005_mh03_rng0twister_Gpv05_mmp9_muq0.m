%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% mex_est_qifspq_099_044_005_mh03_rng0twister_Gpv05_mmp9_muq0.m
% Last modified: AM190604/0611/0806 (muq=0) -> mmp9 version; AM160725 - SEE genTheta_mex099_044_005_mmp9_muq0.m in the "Functions calls"
...
% for the Mexican IMF/IFS (and OECD/National Accounts) quarterly data.
%
...
%     
% Function calls:
%     mex_datadoc_qifspq.m to manipulate and plot data series
%AM150805: added next 
%     genTheta_mex099_044_005_mmp9_muq0.m - fixes the 3 calibrated parameters, beta,
%          alpha and chi, respectively, for Mexico as indicated by the filename
%          NEEDS TO BE CHANGED FOR ANY ALTERNATIVE CALIBRATION!
...
warning off
delete output.txt
diary('mex_est_qifspq_099_044_005_mh03_rng0twister_Gpv05_mmp9_output.txt') 
     %AM150809: country- and calibration-specific output file name 
disp('Estimating for Mexico: NK-foreign VAR model & muq not zero')
...
rng(0,'twister'); % AM151224: here the seed and the PRNG function may be changed for EACH run
...
disp(['rng (0,twister)']); % AM160113 addition to print out in output file

%% Import COUNTRY data and setting data frequency and estimation startdate
[data,datadate,raw] = xlsread('data/mexdata_qifspq.xlsx'); % AM150730: NEW IFS-based data set including a proxy for d(t)
...
sampldate = 1999;
startdate = 2002; %AM150730: 2001 and 2002 are NOISY, with TRENDING DOWN inflation and interest rates in Mexico

% Call function to manipulate and plot data
[newdata,dtitle,date_vec] = mex_datadoc_qifspq(COUNTRY,data,datadate,interval,sampldate,startdate,PLOT_DATA); % APR07042019: had trouble plotting data
...
% mex_datadoc_qifspq, THE REDUCTION BY 3 COLUMNS JUST ABOVE of newdata AFFECTS its SIZE, AND HENCE
...
%Error in mex_est_qifspq_099_044_005_mh03_rng0twister_Gpv05_mmp9 (line 364)
...
%
%Error in mex_est_qifspq_099_044_005_mh03_rng0twister_Gpv05_mmp9 (line 263)
%    Theta = mh_init "
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
save initiallikepriNK_mex_est_qifspq_099_044_005_mh03_rng0twister_Gpv05_mmp9 loglikelogpri %AM160222 %AM190604 _mmp9
...
for j=1:N,
        ...
        [newTheta] = genTheta_mex099_044_005_mmp9_muq0(Theta, 0, variance_normal, npara, bounds); %generate new Theta
                                  %AM190604 _mmp9  
...
fid4=fopen('mex_est_qifspq_099_044_005_mh03_rng0twister_Gpv05_mmp9_NKsummary.txt','w+'); %AM190604 _mmp9
...
matrix2latex2(priormat, 'mex_est_qifspq_099_044_005_MEXprior.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny'); %AM160305 format 3 deicmals    

collabel = {'Post Mean','Post SD','2.5\%','97.5\%'};        
matrix2latex2(newstatmat, 'mex_est_qifspq_099_044_005_mh03_rng0twister_Gpv05_mmp9_MEXstat.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny'); 
        
% AM160222: adding a table for convmat
collabel = {'NSE(8\%)','p-value','B-G'};        
matrix2latex2(convmat, 'mex_est_qifspq_099_044_005_mh03_rng0twister_Gpv05_mmp9_MEXconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny');
...
matrix2latex2(statconvmat, 'mex_est_qifspq_099_044_005_mh03_rng0twister_Gpv05_mmp9_MEXstatconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny');
...
disp('DONE estimating for Mexico: NK-foreign VAR model & muq not zero')