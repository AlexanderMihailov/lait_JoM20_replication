function [AA,BB,PROBLEM] = model_solve_kll(Theta,POLICY)

% model_solve_kll.m
% Last modified: AM160518
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ynames = [  'Consumption     '; 
            ...
            %'\epsilon_{g}    '];	 % added Antonio, July 2015
...
OMEGA = diag([siga,sigh,sigf,sigq,sigs,a4,b4,c4,sigr,zeros(1,ny-nz)],0); %added sigg for shock preference Antonio July 2015 -> deleted: AM160518
...
% Model setup HERE 
% Consumption Euler (as written in the paper)----> Added Antonio Sep, 2014 -> commented out: AM160518
%A0(1,1) = 1 + h;                % c(t)
%A0(1,9) = (1-h)/sigma;          % r(t) 
%A0(1,23) = -(1-h)/sigma;        % epsilon_g(t)
%A1(1,1) = h;                    % c(t-1)        
%A2(1,1) = 1;                    % Et_c(t+1)
%A2(1,7) = (1-h)/sigma;          % Et_pi(t+1)
%A2(1,23) = -(1-h)/sigma;        % Et_epsilon_g(t+1)

% Consumption Euler (as written in the paper) -> inserted, KLL eq. (20): AM160518
A0(1,1) = 1 + h;                % c(t)
A0(1,9) = (1-h)/sigma;          % r(t) 
%A0(1,23) = -(1-h)/sigma;        % epsilon_g(t)
A1(1,1) = h;                    % c(t-1)        
...
A2(4,7) = 1;                   
A2(4,15) = -1;
A5(4,13) = 1;                    % commented in (with 13 as index for epsilon_q, not 5 as it - wrongly - was): AM160518
%A0(4,13) = chi;                 % epsilon_q(t) -> commented out: AM160518
%A0(4,22) = chi;                 % Added by Antonio 23-09-2014 -> commented out: AM160518
...
% New Equations added by Antonio,  -> commented out: AM160518
...
% AR(1) Preference shock -> commented out: AM160518
%A0(23,23) = 1;
%A1(23,23) = rhog;
%A5(23,10) = 1;
