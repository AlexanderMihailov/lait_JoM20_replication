%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% per_est_qifspq_099_035_005_mh085_rng14twister_Gpv05_mmp9_muq0.m
% Last modified: AM190604/0611/0814 (muq=0) -> mmp9 version; AM160725 - SEE genTheta_per099_035_005_mmp9_muq0.m in the "Functions calls"
...
warning off
delete output.txt
diary('per_est_qifspq_099_035_005_mh085_rng14twister_Gpv05_mmp9_output.txt') 
     %AM150809: country- and calibration-specific output file name 
disp('Estimating for Peru: NK-foreign VAR model & muq not zero')
...
mh_scale = 0.875;    % scale variance to obtain optimal acceptance rate (20%) [AM190814: after many trials from 0.05 to 1.5...]
...
%Error in per_est_qifspq_099_035_005_mh085_rng14twister_Gpv05_mmp9 (line 364)
...
%
%Error in per_est_qifspq_099_035_005_mh085_rng14twister_Gpv05_mmp9 (line 263)
%    Theta = mh_init "
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
save initiallikepriNK_per_est_qifspq_099_035_005_mh085_rng14twister_Gpv05_mmp9 loglikelogpri %AM160222 %AM190604 _mmp9
...
fid4=fopen('per_est_qifspq_099_035_005_mh085_rng14twister_Gpv05_mmp9_NKsummary.txt','w+'); %AM190604 _mmp9
...
matrix2latex2(newstatmat, 'per_est_qifspq_099_035_005_mh085_rng14twister_Gpv05_mmp9_PERstat.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny'); 
        
% AM160222: adding a table for convmat
collabel = {'NSE(8\%)','p-value','B-G'};        
matrix2latex2(convmat, 'per_est_qifspq_099_035_005_mh085_rng14twister_Gpv05_mmp9_PERconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny');
...
matrix2latex2(statconvmat, 'per_est_qifspq_099_035_005_mh085_rng14twister_Gpv05_mmp9_PERstatconv.tex', 'rowLabels', rowlabel, ...
            'columnLabels', collabel, 'alignment', 'c', 'format', '%-6.3f','size', 'tiny');
...
disp('DONE estimating for Peru: NK-foreign VAR model & muq not zero')