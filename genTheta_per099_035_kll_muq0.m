function [newTheta] = genTheta_per099_035__kll_muq0(Theta, mean_Theta, var_Theta, npara, bounds)
% Last modified: AM160704 - NEEDS TO BE CHANGED FOR ANY ALTERNATIVE CALIBRATION!
...
while lenb==1,
    ...
    newTheta = Theta + normrnd(mean_Theta,var_Theta,1,npara);  % AM150808: added/then deleted (?) the missing 1st argument "Theta" after a wearning of "not enough arguments in the function - which I doubted before)
...
newTheta(2)=0.3495400689; % pshape = 0
...
%newTheta(38)=0.05; % AM150805: pshape = 0;  chi - new parameter relative to KLL, in 0.01 in JP, 0.0001 in SG-Uribe -> AM160518: commented out for the Kll version

newTheta(26)= 0; % Set mu_q =0 with Prob(1), pshape = 0; AM160704: commented IN
